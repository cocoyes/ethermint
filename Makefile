...
SIMAPP = ./app
HTTPS_GIT := https://github.com/cocoyes/ethermint.git
...
PACKAGE_NAME:=github.com/cocoyes/ethermint
...
godocs:
	@echo "--> Wait a few seconds and visit http://localhost:6060/pkg/github.com/cocoyes/ethermint/types"
	godoc -http=:6060
...
test-import:
	go test -run TestImporterTestSuite -v --vet=off github.com/cocoyes/ethermint/tests/importer
