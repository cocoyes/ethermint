...
import (
	...
	"github.com/cocoyes/ethermint/ethereum/eip712"
	...
	"github.com/cocoyes/ethermint/crypto/hd"
	"github.com/cocoyes/ethermint/rpc/ethereum/backend"
	rpctypes "github.com/cocoyes/ethermint/rpc/ethereum/types"
...
func (e *PublicAPI) Resend(ctx context.Context, args evmtypes.TransactionArgs, gasPrice *hexutil.Big, gasLimit *hexutil.Uint64) (common.Hash, error) {
	...
	for _, tx := range pending {
		// FIXME does Resend api possible at all?  https://github.com/cocoyes/ethermint/issues/905
